import{S as e}from"./QueenCombBabylon-DJ7kDGWi.js";const i="bonesDeclaration",m=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=m);const E={name:i,shader:m},t="bakedVertexAnimationDeclaration",f=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=f);const l={name:t,shader:f},r="instancesVertex",d=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=d);const N={name:r,shader:d},a="bonesVertex",s=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=s);const x={name:a,shader:s},n="bakedVertexAnimation",o=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=o);const I={name:n,shader:o};export{l as a,E as b,x as c,I as d,N as i};
