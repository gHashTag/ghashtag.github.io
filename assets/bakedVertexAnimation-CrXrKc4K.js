import{bS as e}from"./Queen-DhSf2O0T.js";const t="bonesDeclaration",f=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=f);const l={name:t,shader:f},r="bakedVertexAnimationDeclaration",d=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=d);const x={name:r,shader:d},n="instancesDeclaration",m=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=m);const E={name:n,shader:m},i="instancesVertex",o=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=o);const N={name:i,shader:o},a="bonesVertex",u=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=u);const S={name:a,shader:u},s="bakedVertexAnimation",c=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=c);const T={name:s,shader:c};export{x as a,l as b,N as c,S as d,T as e,E as i};
