import{bS as e}from"./Queen-BJ52hr6a.js";const i="bonesDeclaration",m=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=m);const N={name:i,shader:m},t="bakedVertexAnimationDeclaration",f=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=f);const x={name:t,shader:f},r="instancesDeclaration",s=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=s);const u={name:r,shader:s},a="instancesVertex",o=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=o);const I={name:a,shader:o},n="bonesVertex",c=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=c);const S={name:n,shader:c},d="bakedVertexAnimation",E=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=E);const A={name:d,shader:E};export{x as a,N as b,I as c,S as d,A as e,u as i};
