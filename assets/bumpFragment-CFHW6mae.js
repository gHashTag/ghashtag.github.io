import{S as a}from"./QueenCombBabylon-CfZ2XGau.js";import"./reflectionFunction-CDgn5JPr.js";const e="bumpFragmentMainFunctions",f=`#ifndef TEXRD_DEFINED
...
#endif
`;a.IncludesShadersStoreWGSL[e]||(a.IncludesShadersStoreWGSL[e]=f);const v={name:e,shader:f},r="bumpFragmentFunctions",n=`#if defined(BUMP)
...
#endif
`;a.IncludesShadersStoreWGSL[r]||(a.IncludesShadersStoreWGSL[r]=n);const d={name:r,shader:n},t="bumpFragment",m=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;a.IncludesShadersStoreWGSL[t]||(a.IncludesShadersStoreWGSL[t]=m);const o={name:t,shader:m};export{d as a,v as b,o as c};
