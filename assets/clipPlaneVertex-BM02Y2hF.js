import{ar as e}from"./QueenComb-DWw-ZfuD.js";const t="bonesDeclaration",m=`#if NUM_BONE_INFLUENCERS>0
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=o);const p={name:i,shader:o},n="instancesDeclaration",u=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=u);const v={name:n,shader:u},r="clipPlaneVertexDeclaration",l=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=x);const _={name:d,shader:x};export{p as a,S as b,A as c,T as d,L as e,V as f,_ as g,v as i};
