import{S as e}from"./QueenCombBabylon-Ch90MSLm.js";const i="bonesDeclaration",m=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=m);const I={name:i,shader:m},t="bakedVertexAnimationDeclaration",s=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=s);const u={name:t,shader:s},a="clipPlaneVertexDeclaration",o=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=o);const S={name:a,shader:o},n="instancesVertex",c=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=c);const A={name:n,shader:c},r="bonesVertex",l=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=l);const V={name:r,shader:l},f="bakedVertexAnimation",E=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=E);const T={name:f,shader:E},d="clipPlaneVertex",N=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=N);const p={name:d,shader:N};export{u as a,I as b,S as c,V as d,T as e,p as f,A as i};
