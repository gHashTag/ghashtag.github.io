import{ar as e}from"./QueenComb-B5W5cCCZ.js";import{s as ee,m as ie,d as te,a as oe,l as re}from"./logDepthDeclaration-XEFVJfJ8.js";import{h as ae}from"./helperFunctions-DnIQsthL.js";import{c as ne,a as le}from"./clipPlaneFragment-BS4OWsGh.js";import{f as se,a as fe}from"./fogFragment-B0qDkXJI.js";import"./index-Lacmn5nj.js";import"./react-D-uFLJMr.js";import"./motion-mybjp1Q4.js";import"./router-4H5ws2tv.js";import"./queenRepositoryWorld-CyuPyfZ9.js";const t="decalFragmentDeclaration",P=`#ifdef DECAL
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=F);const he={name:a,shader:F},n="oitDeclaration",N=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=N);const ue={name:n,shader:N},l="lightFragmentDeclaration",M=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=M);const pe={name:l,shader:M},s="lightUboDeclaration",_=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=U);const Ce={name:v,shader:U},h="samplerFragmentDeclaration",W=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=W);const De={name:h,shader:W},u="fresnelFunction",H=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=H);const Te={name:u,shader:H},p="reflectionFunction",z=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=z);const Le={name:p,shader:z},m="imageProcessingDeclaration",V=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=V);const Ie={name:m,shader:V},g="imageProcessingFunctions",G=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=G);const we={name:g,shader:G},S="textureRepetitionFunctions",B=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=B);const xe={name:S,shader:B},E="bumpFragmentMainFunctions",k=`#ifndef TEXRD_DEFINED
#define TEXRD(s,uv) texture2D(s,uv)
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=k);const Ae={name:E,shader:k},C="bumpFragmentFunctions",Y=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=Y);const Pe={name:C,shader:Y},D="bumpFragment",$=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=$);const Re={name:D,shader:$},T="decalFragment",Z=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=Z);const Xe={name:T,shader:Z},L="depthPrePass",j=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=j);const Fe={name:L,shader:j},I="lightFragment",q=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=q);const Ne={name:I,shader:q},w="logDepthFragment",Q=`#ifdef LOGARITHMICDEPTH
gl_FragDepthEXT=log2(vFragmentDepth)*logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=Q);const Me={name:w,shader:Q},x="oitFragment",J=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[x]||(e.IncludesShadersStore[x]=J);const _e={name:x,shader:J},A="defaultPixelShader",K=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[A]||(e.ShadersStore[A]=K);const Oe=[de,ce,ee,ie,te,ve,he,ue,oe,ae,pe,me,ge,Se,Ee,Ce,De,Te,Le,Ie,we,xe,Ae,Pe,ne,re,se,le,Re,Xe,Fe,Ne,Me,fe,_e];for(const i of Oe)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const Ye={name:A,shader:K};export{Ye as defaultPixelShader};
