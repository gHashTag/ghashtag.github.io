import{S as e}from"./QueenCombBabylon-Ch90MSLm.js";import{s as Y,m as $}from"./meshUboDeclaration-CmvZlLbR.js";import{d as q,m as j}from"./mainUVVaryingDeclaration-DJmbUn7d.js";import{h as Z}from"./helperFunctions-C_TPpeTi.js";import{c as Q,a as J}from"./clipPlaneFragment-DB4JWnUo.js";import{l as K}from"./logDepthDeclaration-CUHUuy8K.js";import{f as ee,a as re}from"./fogFragment-CiqB1Gqd.js";import{l as te}from"./logDepthFragment-XhYxM1vA.js";import"./react-Be6y7_DR.js";import"./three-C7rSOEFP.js";import"./Queen-CFJEwTqY.js";import"./index-DHAlv9Zs.js";import"./motion-CsGAkEsf.js";import"./router-BHJoP3Ih.js";const t="prePassDeclaration",E=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=E);const ae={name:t,shader:E},a="oitDeclaration",I=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=I);const ie={name:a,shader:I},i="lightUboDeclaration",D=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=D);const oe={name:i,shader:D},o="ltcHelperFunctions",A=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=A);const fe={name:o,shader:A},f="clusteredLightingFunctions",P=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=P);const ne={name:f,shader:P},n="clusteredLightingCompute",X=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=X);const se={name:n,shader:X},s="lightsFragmentFunctions",R=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=R);const le={name:s,shader:R},l="shadowsFragmentFunctions",_=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=_);const de={name:l,shader:_},d="samplerFragmentDeclaration",y=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=y);const ce={name:d,shader:y},c="fresnelFunction",N=`#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=N);const ve={name:c,shader:N},v="reflectionFunction",F=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=F);const ue={name:v,shader:F},u="imageProcessingDeclaration",M=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=M);const pe={name:u,shader:M},p="imageProcessingFunctions",O=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=O);const he={name:p,shader:O},h="textureRepetitionFunctions",b=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=b);const me={name:h,shader:b},m="bumpFragmentMainFunctions",W=`#ifndef TEXRD_DEFINED
fn TEXRD(t: texture_2d<f32>,ts: sampler,uv: vec2f)->vec4f {return textureSample(t,ts,uv);}
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=W);const Se={name:m,shader:W},S="bumpFragmentFunctions",U=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=U);const ge={name:S,shader:U},g="bumpFragment",z=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=z);const xe={name:g,shader:z},x="decalFragment",G=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=G);const Te={name:x,shader:G},T="depthPrePass",H=`#ifdef DEPTHPREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=H);const Le={name:T,shader:H},L="lightFragment",V=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[L]||(e.IncludesShadersStoreWGSL[L]=V);const Ce={name:L,shader:V},C="oitFragment",k=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=k);const we={name:C,shader:k},w="defaultPixelShader",B=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[w]||(e.ShadersStoreWGSL[w]=B);const Ee=[Y,$,q,ae,ie,j,Z,oe,fe,ne,se,le,de,ce,ve,ue,pe,he,me,Se,ge,Q,K,ee,J,xe,Te,Le,Ce,te,re,we];for(const r of Ee)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const Ue={name:w,shader:B};export{Ue as defaultPixelShaderWGSL};
