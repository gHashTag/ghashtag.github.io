import{S as e}from"./QueenCombBabylon-Ch90MSLm.js";import{s as j,m as Q}from"./meshUboDeclaration-BYxIKdkU.js";import{d as J,m as K}from"./mainUVVaryingDeclaration-DB1F4djn.js";import{h as ee}from"./helperFunctions-DQ3-AnC0.js";import{c as ie,a as te}from"./clipPlaneFragment-BCdKLeKM.js";import{l as oe}from"./logDepthDeclaration-Y15Bp4v4.js";import{f as re,a as ae}from"./fogFragment-Cx-w7meJ.js";import{l as ne}from"./logDepthFragment-DDqXD6pd.js";import"./react-Be6y7_DR.js";import"./three-C7rSOEFP.js";import"./Queen-CFJEwTqY.js";import"./index-DHAlv9Zs.js";import"./motion-CsGAkEsf.js";import"./router-BHJoP3Ih.js";const t="decalFragmentDeclaration",x=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=x);const le={name:t,shader:x},o="defaultFragmentDeclaration",A=`uniform vec4 vEyePosition;uniform vec4 vDiffuseColor;uniform vec4 vSpecularColor;uniform vec3 vEmissiveColor;uniform vec3 vAmbientColor;uniform float visibility;
#ifdef DIFFUSE
...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=A);const se={name:o,shader:A},r="prePassDeclaration",P=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=P);const fe={name:r,shader:P},a="oitDeclaration",R=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=R);const de={name:a,shader:R},n="lightFragmentDeclaration",X=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=X);const ce={name:n,shader:X},l="lightUboDeclaration",F=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=N);const he={name:s,shader:N},f="clusteredLightingFunctions",M=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=M);const ue={name:f,shader:M},d="lightsFragmentFunctions",_=`struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
#endif
...
return result;}
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=_);const pe={name:d,shader:_},c="shadowsFragmentFunctions",O=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=O);const me={name:c,shader:O},v="samplerFragmentDeclaration",y=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=y);const ge={name:v,shader:y},h="fresnelFunction",b=`#ifdef FRESNEL
float computeFresnelTerm(vec3 viewDirection,vec3 worldNormal,float bias,float power)
{float fresnelTerm=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStore[h]||(e.IncludesShadersStore[h]=b);const Se={name:h,shader:b},u="reflectionFunction",U=`vec3 computeFixedEquirectangularCoords(vec4 worldPos,vec3 worldNormal,vec3 direction)
...
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=U);const Ee={name:u,shader:U},p="imageProcessingDeclaration",W=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=W);const Ce={name:p,shader:W},m="imageProcessingFunctions",H=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=H);const De={name:m,shader:H},g="textureRepetitionFunctions",z=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=z);const Te={name:g,shader:z},S="bumpFragmentMainFunctions",V=`#ifndef TEXRD_DEFINED
#define TEXRD(s,uv) texture2D(s,uv)
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=V);const Le={name:S,shader:V},E="bumpFragmentFunctions",G=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=G);const Ie={name:E,shader:G},C="bumpFragment",B=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=B);const we={name:C,shader:B},D="decalFragment",k=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=k);const xe={name:D,shader:k},T="depthPrePass",Y=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=Y);const Ae={name:T,shader:Y},L="lightFragment",$=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=$);const Pe={name:L,shader:$},I="oitFragment",Z=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=Z);const Re={name:I,shader:Z},w="defaultPixelShader",q=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[w]||(e.ShadersStore[w]=q);const Xe=[le,se,j,Q,J,fe,de,K,ee,ce,ve,he,ue,pe,me,ge,Se,Ee,Ce,De,Te,Le,Ie,ie,oe,re,te,we,xe,Ae,Pe,ne,ae,Re];for(const i of Xe)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const ke={name:w,shader:q};export{ke as defaultPixelShader};
