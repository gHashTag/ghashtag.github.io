import{ar as e}from"./QueenComb-B5W5cCCZ.js";import{s as Z,m as Q,d as J,a as K,l as ee}from"./logDepthDeclaration-r0T-HfML.js";import{h as re}from"./helperFunctions-CpLxwu49.js";import{c as te,a as ae}from"./clipPlaneFragment-B70F8VAF.js";import{f as ie,a as oe}from"./fogFragment-D7ZWowhC.js";import"./index-Lacmn5nj.js";import"./react-D-uFLJMr.js";import"./motion-mybjp1Q4.js";import"./router-4H5ws2tv.js";import"./queenRepositoryWorld-CyuPyfZ9.js";const t="objectIdFunctions",D=`fn encodeObjectId(objectId: f32)->vec4f {
...
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=D);const fe={name:t,shader:D},a="prePassDeclaration",A=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=A);const ne={name:a,shader:A},i="oitDeclaration",P=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=P);const se={name:i,shader:P},o="lightUboDeclaration",X=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=X);const le={name:o,shader:X},f="ltcHelperFunctions",R=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=R);const de={name:f,shader:R},n="clusteredLightingFunctions",_=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=_);const ce={name:n,shader:_},s="clusteredLightingCompute",y=`#if defined(CLUSTLIGHT{X}) && defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=y);const ve={name:s,shader:y},l="lightsFragmentFunctions",F=`struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=F);const ue={name:l,shader:F},d="shadowsFragmentFunctions",N=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=N);const pe={name:d,shader:N},c="samplerFragmentDeclaration",M=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=M);const he={name:c,shader:M},v="fresnelFunction",O=`#ifdef FRESNEL
fn computeFresnelTerm(viewDirection: vec3f,worldNormal: vec3f,bias: f32,power: f32)->f32
{let fresnelTerm: f32=pow(bias+abs(dot(viewDirection,worldNormal)),power);return clamp(fresnelTerm,0.,1.);}
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=O);const me={name:v,shader:O},u="reflectionFunction",b=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=b);const Se={name:u,shader:b},p="imageProcessingDeclaration",W=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=W);const ge={name:p,shader:W},h="imageProcessingFunctions",U=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=U);const xe={name:h,shader:U},m="textureRepetitionFunctions",z=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=z);const Te={name:m,shader:z},S="bumpFragmentMainFunctions",G=`#ifndef TEXRD_DEFINED
fn TEXRD(t: texture_2d<f32>,ts: sampler,uv: vec2f)->vec4f {return textureSample(t,ts,uv);}
#define TEXRD_DEFINED
#endif
...
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=G);const Le={name:S,shader:G},g="bumpFragmentFunctions",H=`#if defined(BUMP)
...
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=H);const Ce={name:g,shader:H},x="bumpFragment",V=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=V);const we={name:x,shader:V},T="decalFragment",k=`#ifdef DECAL
...
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=k);const Ee={name:T,shader:k},L="depthPrePass",B=`#ifdef DEPTHPREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[L]||(e.IncludesShadersStoreWGSL[L]=B);const Ie={name:L,shader:B},C="lightFragment",Y=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=Y);const De={name:C,shader:Y},w="logDepthFragment",$=`#ifdef LOGARITHMICDEPTH
fragmentOutputs.fragDepth=log2(fragmentInputs.vFragmentDepth)*uniforms.logarithmicDepthConstant*0.5;
#endif
`;e.IncludesShadersStoreWGSL[w]||(e.IncludesShadersStoreWGSL[w]=$);const Ae={name:w,shader:$},E="oitFragment",j=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=j);const Pe={name:E,shader:j},I="defaultPixelShader",q=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[I]||(e.ShadersStoreWGSL[I]=q);const Xe=[Z,Q,J,fe,ne,se,K,re,le,de,ce,ve,ue,pe,he,me,Se,ge,xe,Te,Le,Ce,te,ee,ie,ae,we,Ee,Ie,De,Ae,oe,Pe];for(const r of Xe)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const ze={name:I,shader:q};export{ze as defaultPixelShaderWGSL};
