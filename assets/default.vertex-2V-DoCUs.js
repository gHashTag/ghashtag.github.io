import{S as e}from"./QueenCombBabylon-Ch90MSLm.js";import{s as M,m as g}from"./meshUboDeclaration-CmvZlLbR.js";import{d as P,m as R}from"./mainUVVaryingDeclaration-DJmbUn7d.js";import{h as D}from"./helperFunctions-C_TPpeTi.js";import{b as X,a as W,c as b,i as F,d as G,e as z,f as C}from"./clipPlaneVertex-CEe6kMDs.js";import{i as B,f as w,v as H}from"./vertexColorMixing-9yNb81Fz.js";import{f as Y}from"./fogVertexDeclaration-PqJngMQ5.js";import{m as $,a as j,b as k,c as Q}from"./morphTargetsVertex-CWaP7heB.js";import{l as K}from"./logDepthDeclaration-CUHUuy8K.js";import{l as Z}from"./logDepthVertex-BiUFxfS5.js";import"./react-Be6y7_DR.js";import"./three-C7rSOEFP.js";import"./Queen-CFJEwTqY.js";import"./index-DHAlv9Zs.js";import"./motion-CsGAkEsf.js";import"./router-BHJoP3Ih.js";const i="uvAttributeDeclaration",m=`#if defined(UV{X}) && !defined(USE_VERTEX_PULLING)
attribute uv{X}: vec2f;
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=m);const q={name:i,shader:m},a="prePassVertexDeclaration",E=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=E);const J={name:a,shader:E},r="samplerVertexDeclaration",x=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
varying v_VARYINGNAME_UV: vec2f;
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=x);const ee={name:r,shader:x},n="bumpVertexDeclaration",I=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL) 
varying vTBN0: vec3f;varying vTBN1: vec3f;varying vTBN2: vec3f;
#endif
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=I);const te={name:n,shader:I},f="lightVxFragmentDeclaration",V=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=V);const ie={name:f,shader:V},d="lightVxUboDeclaration",S=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=S);const ae={name:d,shader:S},o="vertexPullingDeclaration",N=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=N);const re={name:o,shader:N},s="vertexPullingVertex",T=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=T);const ne={name:s,shader:T},v="prePassVertex",A=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=A);const fe={name:v,shader:A},u="uvVariableDeclaration",O=`#ifdef MAINUV{X}
#if !defined(UV{X})
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=O);const de={name:u,shader:O},l="samplerVertexImplementation",U=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=U);const oe={name:l,shader:U},p="bumpVertex",h=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL)
var tbnNormal: vec3f=normalize(normalUpdated);var tbnTangent: vec3f=normalize(tangentUpdated.xyz);var tbnBitangent: vec3f=cross(tbnNormal,tbnTangent)*tangentUpdated.w;var matTemp= mat3x3f(finalWorld[0].xyz,finalWorld[1].xyz,finalWorld[2].xyz)* mat3x3f(tbnTangent,tbnBitangent,tbnNormal);vertexOutputs.vTBN0=matTemp[0];vertexOutputs.vTBN1=matTemp[1];vertexOutputs.vTBN2=matTemp[2];
#endif
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=h);const se={name:p,shader:h},c="shadowsVertex",y=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=y);const ve={name:c,shader:y},_="defaultVertexShader",L=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[_]||(e.ShadersStoreWGSL[_]=L);const ue=[M,g,P,q,D,X,W,B,J,R,ee,te,b,Y,ie,ae,$,j,K,re,ne,k,Q,F,G,z,fe,de,oe,se,C,w,ve,H,Z];for(const t of ue)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const ye={name:_,shader:L};export{ye as defaultVertexShaderWGSL};
