import{S as e}from"./QueenCombBabylon-cBwhf22i.js";import{s as W,m as F,d as z,a as C}from"./mainUVVaryingDeclaration-DY0t2XDF.js";import{h as H}from"./helperFunctions-CYQm3YBF.js";import{b as w,a as B,i as Y,c as $,d as j,e as k,f as Q,g as K,h as Z,v as q}from"./vertexColorMixing-Dr_cv9Qj.js";import{f as J}from"./fogVertexDeclaration-FbB9Mx-X.js";import{l as ee}from"./logDepthDeclaration-C-XXQ36H.js";import{l as te}from"./logDepthVertex-BxJ3xEql.js";import"./react-Be6y7_DR.js";import"./three-C7rSOEFP.js";import"./Queen-CRQhWGsa.js";import"./index-DLCfuEAH.js";import"./motion-CsGAkEsf.js";import"./router-BHJoP3Ih.js";const i="uvAttributeDeclaration",T=`#if defined(UV{X}) && !defined(USE_VERTEX_PULLING)
attribute uv{X}: vec2f;
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=T);const ie={name:i,shader:T},r="prePassVertexDeclaration",S=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=S);const re={name:r,shader:S},a="samplerVertexDeclaration",V=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
varying v_VARYINGNAME_UV: vec2f;
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=V);const ae={name:a,shader:V},n="bumpVertexDeclaration",U=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL) 
varying vTBN0: vec3f;varying vTBN1: vec3f;varying vTBN2: vec3f;
#endif
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=U);const ne={name:n,shader:U},f="lightVxFragmentDeclaration",N=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=N);const fe={name:f,shader:N},d="lightVxUboDeclaration",h=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=h);const de={name:d,shader:h},o="morphTargetsVertexGlobalDeclaration",O=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=O);const oe={name:o,shader:O},s="morphTargetsVertexDeclaration",A=`#ifdef MORPHTARGETS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=A);const se={name:s,shader:A},u="vertexPullingDeclaration",g=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=g);const ue={name:u,shader:g},v="vertexPullingVertex",R=`#ifdef USE_VERTEX_PULLING
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=R);const ve={name:v,shader:R},l="morphTargetsVertexGlobal",L=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
var vertexID : f32;
#endif
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=L);const le={name:l,shader:L},p="morphTargetsVertex",M=`#ifdef MORPHTARGETS
#ifdef MORPHTARGETS_TEXTURE
#if {X}==0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=M);const pe={name:p,shader:M},c="prePassVertex",y=`#ifdef PREPASS_DEPTH
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=y);const ce={name:c,shader:y},m="uvVariableDeclaration",P=`#ifdef MAINUV{X}
#if !defined(UV{X})
...
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=P);const me={name:m,shader:P},_="samplerVertexImplementation",X=`#if defined(_DEFINENAME_) && _DEFINENAME_DIRECTUV==0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=X);const _e={name:_,shader:X},x="bumpVertex",D=`#if defined(BUMP) || defined(PARALLAX) || defined(CLEARCOAT_BUMP) || defined(ANISOTROPIC)
#if defined(TANGENT) && defined(NORMAL)
var tbnNormal: vec3f=normalize(normalUpdated);var tbnTangent: vec3f=normalize(tangentUpdated.xyz);var tbnBitangent: vec3f=cross(tbnNormal,tbnTangent)*tangentUpdated.w;var matTemp= mat3x3f(finalWorld[0].xyz,finalWorld[1].xyz,finalWorld[2].xyz)* mat3x3f(tbnTangent,tbnBitangent,tbnNormal);vertexOutputs.vTBN0=matTemp[0];vertexOutputs.vTBN1=matTemp[1];vertexOutputs.vTBN2=matTemp[2];
#endif
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=D);const xe={name:x,shader:D},E="shadowsVertex",G=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=G);const Ee={name:E,shader:G},I="defaultVertexShader",b=`#include<defaultUboDeclaration>
...
`;e.ShadersStoreWGSL[I]||(e.ShadersStoreWGSL[I]=b);const Ie=[W,F,z,ie,H,w,B,Y,re,C,ae,ne,$,J,fe,de,oe,se,ee,ue,ve,le,pe,j,k,Q,ce,me,_e,xe,K,Z,Ee,q,te];for(const t of Ie)e.IncludesShadersStoreWGSL[t.name]||(e.IncludesShadersStoreWGSL[t.name]=t.shader);const Pe={name:I,shader:b};export{Pe as defaultVertexShaderWGSL};
