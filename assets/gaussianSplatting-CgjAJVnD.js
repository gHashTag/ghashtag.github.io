import{S as e}from"./QueenCombBabylon-CfZ2XGau.js";import"./sceneUboDeclaration-Cp0bFJ3u.js";import"./meshUboDeclaration-DHPuCv5r.js";const t="gaussianSplattingVertexDeclaration",o="attribute vec3 position;attribute vec4 splatIndex0;attribute vec4 splatIndex1;attribute vec4 splatIndex2;attribute vec4 splatIndex3;uniform mat4 view;uniform mat4 projection;uniform mat4 world;uniform vec4 vEyePosition;";e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=o);const r={name:t,shader:o},a="gaussianSplattingUboDeclaration",c=`#include<sceneUboDeclaration>
...
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=c);const d={name:a,shader:c},s="gaussianSplatting",i=`#if !defined(WEBGL2) && !defined(WEBGPU) && !defined(NATIVE)
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=i);const p={name:s,shader:i};export{d as a,p as b,r as g};
