import{S as t}from"./QueenCombBabylon-Ccpv0aSp.js";import{g as e,a as r,b as n}from"./gaussianSplatting-32l1eUyf.js";import{s as l}from"./sceneUboDeclaration-Dy10H7Hy.js";import{m as s}from"./meshUboDeclaration-B3pOjavf.js";import"./react-Be6y7_DR.js";import"./three-C7rSOEFP.js";import"./Queen-kFVbQ4B_.js";import"./index-DjsccCAJ.js";import"./motion-CsGAkEsf.js";import"./router-BHJoP3Ih.js";const i="gaussianSplattingVoxelVertexShader",o=`#include<__decl__gaussianSplattingVertex>
...
#endif
vPatchPosition=position.xy;}`;t.ShadersStore[i]||(t.ShadersStore[i]=o);const p=[e,l,s,r,n];for(const a of p)t.IncludesShadersStore[a.name]||(t.IncludesShadersStore[a.name]=a.shader);const h={name:i,shader:o};export{h as gaussianSplattingVoxelVertexShader};
