import{S as e}from"./QueenCombBabylon-Ccpv0aSp.js";import{c as f,a as t}from"./clipPlaneFragment-15BthPiA.js";import{b as d,a as l,c}from"./bumpFragment-xbk9TSzg.js";import{s,r as E}from"./reflectionFunction-Cjp10D-J.js";import{h as m}from"./helperFunctions-BogXfHKz.js";import{p as v,a as u}from"./pbrIBLFunctions-Bz-cYqzI.js";import{s as S,o as I,a as R,b as T,d as p,c as A}from"./openpbrTransmissionLayerData-CgSUXJ_N.js";import{s as D}from"./sceneUboDeclaration-Dy10H7Hy.js";import{p as _}from"./pbrBRDFFunctions-DbQBU2_R.js";import"./react-Be6y7_DR.js";import"./three-C7rSOEFP.js";import"./Queen-kFVbQ4B_.js";import"./index-DjsccCAJ.js";import"./motion-CsGAkEsf.js";import"./router-BHJoP3Ih.js";const n="mrtFragmentDeclaration",a=`#if defined(WEBGL2) || defined(WEBGPU) || defined(NATIVE)
layout(location=0) out vec4 glFragData[{X}];
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=a);const g={name:n,shader:a},r="geometryPixelShader",o=`#extension GL_EXT_draw_buffers : require
...
`;e.ShadersStore[r]||(e.ShadersStore[r]=o);const L=[f,g,d,s,l,m,v,S,D,_,I,u,E,R,T,t,c,p,A];for(const i of L)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const B={name:r,shader:o};export{B as geometryPixelShader};
