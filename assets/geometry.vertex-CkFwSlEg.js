import{bS as e}from"./Queen-BC4nOwIz.js";import{b as f,a as c,i as v,c as s,d as l,e as u}from"./bakedVertexAnimation-Cnv_5tUk.js";import{m,a as U,b as E,c as p}from"./morphTargetsVertex-CgoQwk14.js";import{s as V}from"./sceneUboDeclaration-WuBg4El6.js";import{c as S,a as I}from"./clipPlaneVertex-B_Ig6eUZ.js";import{h}from"./harmonicsFunctions-CLwDmmm2.js";import{b as N}from"./bumpVertex-DfezP8wX.js";import"./index-Dz25SNiT.js";import"./react-BikoVsHo.js";import"./motion-DmZWFm6O.js";import"./router-DHWxIZD9.js";const r="geometryVertexDeclaration",o="uniform mat4 viewProjection;uniform mat4 view;";e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=o);const _={name:r,shader:o},n="geometryUboDeclaration",t=`#include<sceneUboDeclaration>
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=t);const x={name:n,shader:t},a="geometryVertexShader",d=`precision highp float;
...
`;e.ShadersStore[a]||(e.ShadersStore[a]=d);const P=[f,c,m,U,v,_,V,x,S,h,E,p,s,l,u,I,N];for(const i of P)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const y={name:a,shader:d};export{y as geometryVertexShader};
