import{S as e}from"./QueenCombBabylon-C8Ncj2QC.js";import{b as f,a as c,i as v,c as s,d as l}from"./bakedVertexAnimation-g-c-zGsG.js";import{m as u,a as m,b as U,c as p}from"./morphTargetsVertex-BA0kzXIt.js";import{i as E}from"./instancesDeclaration-l9HFN2dZ.js";import{s as V}from"./sceneUboDeclaration-DZWONad_.js";import{c as S,a as I}from"./clipPlaneVertex-BEIe2sgk.js";import{h}from"./harmonicsFunctions-BkhxUQmS.js";import{b as N}from"./bumpVertex-CFxll-0R.js";import"./react-Be6y7_DR.js";import"./three-C7rSOEFP.js";import"./Queen-whyUdQOo.js";import"./index-BtJgdu3X.js";import"./motion-CsGAkEsf.js";import"./router-BHJoP3Ih.js";const r="geometryVertexDeclaration",a="uniform mat4 viewProjection;uniform mat4 view;";e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=a);const _={name:r,shader:a},n="geometryUboDeclaration",t=`#include<sceneUboDeclaration>
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=t);const x={name:n,shader:t},o="geometryVertexShader",d=`precision highp float;
...
`;e.ShadersStore[o]||(e.ShadersStore[o]=d);const P=[f,c,u,m,E,_,V,x,S,h,U,p,v,s,l,I,N];for(const i of P)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const w={name:o,shader:d};export{w as geometryVertexShader};
