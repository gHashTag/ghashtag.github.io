import{ar as e}from"./QueenComb-BX5Hsk-N.js";import{h as f}from"./helperFunctions-CtMuC2P0.js";import{c as o,a as n}from"./clipPlaneFragment-DvIJhxb4.js";import"./index-DFaPcPs8.js";import"./react-BikoVsHo.js";import"./motion-DmZWFm6O.js";import"./router-CAi4bOxy.js";const i="glowMapGenerationPixelShader",r=`#if defined(DIFFUSE_ISLINEAR) || defined(EMISSIVE_ISLINEAR)
...
`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=r);const l=[f,o,n];for(const a of l)e.IncludesShadersStoreWGSL[a.name]||(e.IncludesShadersStoreWGSL[a.name]=a.shader);const u={name:i,shader:r};export{u as glowMapGenerationPixelShaderWGSL};
