import{ar as e}from"./QueenComb-BFnTgH_m.js";import{k as c}from"./kernelBlurVaryingDeclaration-DnQxcm2b.js";import"./index-BWSG-gbq.js";import"./react-BikoVsHo.js";import"./motion-DmZWFm6O.js";import"./router-CAi4bOxy.js";const r="packingFunctions",l=`vec4 pack(float depth)
...
#endif
}`;e.ShadersStore[o]||(e.ShadersStore[o]=i);const p=[c,f,u,m];for(const t of p)e.IncludesShadersStore[t.name]||(e.IncludesShadersStore[t.name]=t.shader);const D={name:o,shader:i};export{D as kernelBlurPixelShader};
