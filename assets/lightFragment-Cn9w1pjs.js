import{S as e}from"./QueenCombBabylon-C8Ncj2QC.js";const i="clusteredLightingFunctions",n=`struct ClusteredLight {vec4 vLightData;vec4 vLightDiffuse;vec4 vLightSpecular;vec4 vLightDirection;vec4 vLightFalloff;};
#define inline
...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=n);const h={name:i,shader:n},t="decalFragment",f=`#ifdef DECAL
#ifdef GAMMADECAL
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=f);const a={name:t,shader:f},o="lightFragment",d=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=d);const r={name:o,shader:d};export{h as c,a as d,r as l};
