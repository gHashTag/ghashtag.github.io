import{S as e}from"./QueenCombBabylon-cBwhf22i.js";const o="sceneUboDeclaration",n=`layout(std140,column_major) uniform;uniform Scene {mat4 viewProjection;
#ifdef MULTIVIEW
mat4 viewProjectionR;
#endif 
mat4 view;mat4 projection;vec4 vEyePosition;mat4 inverseProjection;};
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=n);const v={name:o,shader:n},a="meshUboDeclaration",r=`#ifdef WEBGL2
...
#endif
#define WORLD_UBO
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=r);const l={name:a,shader:r},i="defaultUboDeclaration",c=`layout(std140,column_major) uniform;uniform Material
...
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=c);const m={name:i,shader:c},t="mainUVVaryingDeclaration",s=`#ifdef MAINUV{X}
varying vec2 vMainUV{X};
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=s);const d={name:t,shader:s};export{d as a,m as d,l as m,v as s};
