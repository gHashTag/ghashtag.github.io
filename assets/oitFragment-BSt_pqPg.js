import{S as e}from"./QueenCombBabylon-C8Ncj2QC.js";const r="prePassDeclaration",u=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=u);const C={name:r,shader:u},t="oitDeclaration",l=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#define MAX_DEPTH 99999.0
var oitDepthSamplerSampler: sampler;var oitDepthSampler: texture_2d<f32>;var oitFrontColorSamplerSampler: sampler;var oitFrontColorSampler: texture_2d<f32>;
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=l);const L={name:t,shader:l},a="lightUboDeclaration",n=`#ifdef LIGHT{X}
struct Light{X}
{vLightData: vec4f,
vLightDiffuse: vec4f,
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=n);const _={name:a,shader:n},o="ltcHelperFunctions",h=`fn LTCUv(N: vec3f,V: vec3f,roughness: f32)->vec2f {var LUTSIZE: f32=64.0;var LUTSCALE: f32=( LUTSIZE-1.0 )/LUTSIZE;var LUTBIAS:f32=0.5/LUTSIZE;var dotNV:f32=saturate( dot( N,V ) );var uv:vec2f=vec2f( roughness,sqrt( 1.0-dotNV ) );uv=uv*LUTSCALE+LUTBIAS;return uv;}
...
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=h);const E={name:o,shader:h},f="clusteredLightingFunctions",m=`struct ClusteredLight {vLightData: vec4f,
vLightDiffuse: vec4f,
vLightSpecular: vec4f,
vLightDirection: vec4f,
vLightFalloff: vec4f,}
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=m);const P={name:f,shader:m},v="shadowsFragmentFunctions",x=`#ifdef SHADOWS
#ifndef SHADOWFLOAT
...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=x);const F={name:v,shader:x},s="imageProcessingDeclaration",S=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=S);const z={name:s,shader:S},i="imageProcessingFunctions",w=`#if TONEMAPPING==3
...
return vec4f(rgb,result.a);}`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=w);const I={name:i,shader:w},c="textureRepetitionFunctions",g=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=g);const M={name:c,shader:g},d="depthPrePass",T=`#ifdef DEPTHPREPASS
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=T);const b={name:d,shader:T},p="oitFragment",y=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=y);const A={name:p,shader:y};export{E as a,I as b,P as c,b as d,A as e,z as i,_ as l,L as o,C as p,F as s,M as t};
