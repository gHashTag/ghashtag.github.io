import{S as e}from"./QueenCombBabylon-Ccpv0aSp.js";const t="decalFragmentDeclaration",h=`#ifdef DECAL
uniform vec4 vDecalInfos;
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=h);const P={name:t,shader:h},o="prePassDeclaration",p=`#ifdef PREPASS
...
#endif
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=p);const F={name:o,shader:p},a="oitDeclaration",u=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
#extension GL_EXT_draw_buffers : require
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=u);const L={name:a,shader:u},r="lightFragmentDeclaration",m=`#ifdef LIGHT{X}
...
#endif
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=m);const A={name:r,shader:m},i="lightUboDeclaration",S=`#ifdef LIGHT{X}
uniform Light{X}
...
#endif
result.Diffuse=LTCEvaluateWithEmission( normal,viewDir,position,mat3( 1.0 ),rectCoords,texFilteredMap );return result;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=g);const M={name:s,shader:g},c="shadowsFragmentFunctions",x=`#ifdef SHADOWS
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=x);const R={name:c,shader:x},l="imageProcessingDeclaration",w=`#ifdef EXPOSURE
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=w);const _={name:l,shader:w},v="imageProcessingFunctions",D=`#if defined(COLORGRADING) && !defined(COLORGRADING3D)
/** 
...
return result;}`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=D);const b={name:v,shader:D},n="textureRepetitionFunctions",E=`#if TEXTURE_REPETITION_MODE>0
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=E);const z={name:n,shader:E},d="depthPrePass",T=`#ifdef DEPTHPREPASS
gl_FragColor=vec4(0.,0.,0.,1.0);return;
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=T);const X={name:d,shader:T},f="oitFragment",C=`#ifdef ORDER_INDEPENDENT_TRANSPARENCY
...
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=C);const U={name:f,shader:C};export{I as a,M as b,b as c,P as d,X as e,U as f,_ as i,A as l,L as o,F as p,R as s,z as t};
