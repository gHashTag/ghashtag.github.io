import{S as e}from"./QueenCombBabylon-C8Ncj2QC.js";import{p as H,o as B,d as V,l as k,a as Y,i as Z,t as $,c as j,s as q,b as K,e as Q,f as J}from"./oitFragment-DvrLS5eH.js";import{s as ee,o as ie,a as oe,b as re,c as te,d as ae}from"./openpbrTransmissionLayerData-qJBCT328.js";import{s as ne}from"./sceneUboDeclaration-DZWONad_.js";import{m as se}from"./meshUboDeclaration--q8LxzWH.js";import{o as ce}from"./openpbrUboDeclaration-Dxn8zA74.js";import{m as le}from"./mainUVVaryingDeclaration-OihoF3Tj.js";import{p as fe,s as _e,i as de,a as me,b as ue,c as ge,h as Ee,d as ve,e as pe,f as he,g as Re}from"./pbrDebug-DXLWQk0b.js";import{s as Ie,r as Se}from"./reflectionFunction-LmnCSyzb.js";import{p as Te,a as Ae}from"./pbrIBLFunctions-CwULXelo.js";import{c as Ne,a as be}from"./clipPlaneFragment-tEIjBQdR.js";import{l as Le}from"./logDepthDeclaration-BeV-0z2D.js";import{f as Fe,a as Oe}from"./fogFragment-CSoWB-fd.js";import{h as De}from"./helperFunctions-e_mSHHyp.js";import{h as Ce}from"./harmonicsFunctions-BkhxUQmS.js";import{p as Pe}from"./pbrBRDFFunctions-DId5HuFf.js";import{l as Me}from"./logDepthFragment-CXBoZ-ia.js";import"./react-Be6y7_DR.js";import"./three-C7rSOEFP.js";import"./Queen-whyUdQOo.js";import"./index-BtJgdu3X.js";import"./motion-CsGAkEsf.js";import"./router-BHJoP3Ih.js";const o="openpbrFragmentDeclaration",S=`uniform float vBaseWeight;uniform vec4 vBaseColor;uniform float vBaseDiffuseRoughness;uniform vec4 vReflectanceInfo;uniform vec4 vSpecularColor;uniform vec3 vSpecularAnisotropy;uniform float vTransmissionWeight;uniform vec3 vTransmissionColor;uniform float vTransmissionDepth;uniform vec3 vTransmissionScatter;uniform float vTransmissionScatterAnisotropy;uniform float vTransmissionDispersionScale;uniform float vTransmissionDispersionAbbeNumber;uniform float vSubsurfaceWeight;uniform vec3 vSubsurfaceColor;uniform float vSubsurfaceRadius;uniform vec3 vSubsurfaceRadiusScale;uniform float vSubsurfaceScatterAnisotropy;uniform float vCoatWeight;uniform vec3 vCoatColor;uniform float vCoatRoughness;uniform float vCoatRoughnessAnisotropy;uniform float vCoatIor;uniform float vCoatDarkening;uniform float vFuzzWeight;uniform vec3 vFuzzColor;uniform float vFuzzRoughness;uniform vec2 vGeometryCoatTangent;uniform float vGeometryThickness;uniform vec3 vEmissionColor;uniform float vThinFilmWeight;uniform vec2 vThinFilmThickness;uniform float vThinFilmIor;uniform float vGeometryThinWalled;uniform vec4 vLightingIntensity;uniform float visibility;uniform vec2 renderTargetSize;
#ifdef BASE_COLOR
...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=S);const Ge={name:o,shader:S},r="openpbrFragmentSamplersDeclaration",T=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=T);const xe={name:r,shader:T},t="openpbrNormalMapFragmentMainFunctions",A=`#if defined(GEOMETRY_NORMAL) || defined(GEOMETRY_COAT_NORMAL) || defined(ANISOTROPIC) || defined(FUZZ) || defined(DETAIL)
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=A);const ye={name:t,shader:A},a="openpbrNormalMapFragmentFunctions",N=`#if defined(GEOMETRY_NORMAL)
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=N);const ze={name:a,shader:N},n="openpbrConductorReflectance",b=`#define pbr_inline
...
weight_sum.b<1e-5f ? unconvolved_irradiance.b : irradiance_sum.b/weight_sum.b);}`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=F);const we={name:c,shader:F},l="openpbrNormalMapFragment",O=`vec2 uvOffset=vec2(0.0,0.0);
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=O);const We={name:l,shader:O},f="openpbrBlockNormalFinal",D=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=D);const He={name:f,shader:D},_="openpbrBaseLayerData",C=`vec3 base_color=vec3(0.8);float base_metalness=0.0;float base_diffuse_roughness=0.0;float specular_weight=1.0;float specular_roughness=0.3;vec3 specular_color=vec3(1.0);float specular_roughness_anisotropy=0.0;float specular_ior=1.5;float alpha=1.0;vec2 geometry_tangent=vec2(1.0,0.0);float geometry_thickness=0.0;
#ifdef BASE_WEIGHT
...
`;e.ShadersStore[I]||(e.ShadersStore[I]=W);const Je=[H,B,ee,V,Ge,ne,se,ce,le,fe,k,Y,Ie,Te,xe,Z,Ne,Le,Fe,$,De,_e,de,me,j,q,Ce,K,ue,ge,Pe,Ee,ve,Ae,ye,ze,Se,ie,Ue,Xe,oe,re,we,be,pe,We,He,Be,te,ae,Ve,ke,Ye,Ze,Q,$e,je,qe,Ke,Me,Oe,he,Qe,J,Re];for(const i of Je)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const Ti={name:I,shader:W};export{Ti as openpbrPixelShader};
