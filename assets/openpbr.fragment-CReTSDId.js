import{bG as e}from"./Queen-DY1T7V31.js";import{p as H,o as B,d as V,l as k,a as Y,i as Z,t as $,c as j,s as q,b as K,e as Q,f as J}from"./oitFragment-WOl-0gsj.js";import{s as ee,o as ie,a as oe,b as re,c as te,d as ae}from"./openpbrTransmissionLayerData-D9sZ3631.js";import{s as ne}from"./sceneUboDeclaration-DrKnAlpO.js";import{m as se}from"./meshUboDeclaration-C-ZfIxIs.js";import{o as ce}from"./openpbrUboDeclaration-Cd09UujV.js";import{m as le}from"./mainUVVaryingDeclaration-DR3XJ_Rd.js";import{p as fe,s as _e,i as de,a as me,b as ue,c as ge,h as Ee,d as ve,e as pe,f as he,g as Re}from"./pbrDebug-CpIgfXxJ.js";import{s as Ie,r as Se}from"./reflectionFunction-DysCM-9j.js";import{p as Te,a as Ae}from"./pbrIBLFunctions-B4Lern0y.js";import{c as Ne,a as be}from"./clipPlaneFragment-CkkeQ6Fg.js";import{l as Le}from"./logDepthDeclaration-CRDYniYW.js";import{f as Fe,a as Oe}from"./fogFragment-DRy6Rtg3.js";import{h as De}from"./helperFunctions-Dwmc7TGt.js";import{h as Ce}from"./harmonicsFunctions-B2P9rCyw.js";import{p as Pe}from"./pbrBRDFFunctions-DJcRglgg.js";import{l as Me}from"./logDepthFragment-MmHnMATi.js";import"./index-DoquhqV3.js";import"./react-BikoVsHo.js";import"./motion-DmZWFm6O.js";import"./router-DHWxIZD9.js";const o="openpbrFragmentDeclaration",S=`uniform float vBaseWeight;uniform vec4 vBaseColor;uniform float vBaseDiffuseRoughness;uniform vec4 vReflectanceInfo;uniform vec4 vSpecularColor;uniform vec3 vSpecularAnisotropy;uniform float vTransmissionWeight;uniform vec3 vTransmissionColor;uniform float vTransmissionDepth;uniform vec3 vTransmissionScatter;uniform float vTransmissionScatterAnisotropy;uniform float vTransmissionDispersionScale;uniform float vTransmissionDispersionAbbeNumber;uniform float vSubsurfaceWeight;uniform vec3 vSubsurfaceColor;uniform float vSubsurfaceRadius;uniform vec3 vSubsurfaceRadiusScale;uniform float vSubsurfaceScatterAnisotropy;uniform float vCoatWeight;uniform vec3 vCoatColor;uniform float vCoatRoughness;uniform float vCoatRoughnessAnisotropy;uniform float vCoatIor;uniform float vCoatDarkening;uniform float vFuzzWeight;uniform vec3 vFuzzColor;uniform float vFuzzRoughness;uniform vec2 vGeometryCoatTangent;uniform float vGeometryThickness;uniform vec3 vEmissionColor;uniform float vThinFilmWeight;uniform vec2 vThinFilmThickness;uniform float vThinFilmIor;uniform float vGeometryThinWalled;uniform vec4 vLightingIntensity;uniform float visibility;uniform vec2 renderTargetSize;
#ifdef BASE_COLOR
...
`;e.ShadersStore[I]||(e.ShadersStore[I]=W);const Je=[H,B,ee,V,Ge,ne,se,ce,le,fe,k,Y,Ie,Te,xe,Z,Ne,Le,Fe,$,De,_e,de,me,j,q,Ce,K,ue,ge,Pe,Ee,ve,Ae,ye,ze,Se,ie,Ue,Xe,oe,re,we,be,pe,We,He,Be,te,ae,Ve,ke,Ye,Ze,Q,$e,je,qe,Ke,Me,Oe,he,Qe,J,Re];for(const i of Je)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const Ii={name:I,shader:W};export{Ii as openpbrPixelShader};
