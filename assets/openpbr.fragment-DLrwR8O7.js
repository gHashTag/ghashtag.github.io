import{bM as e}from"./Queen-CMaJNJEY.js";import{p as w,o as X,l as H,i as B,t as V,b as k,s as Y,a as Z,c as j,d as $,e as q}from"./oitFragment-CqmB1bVv.js";import{s as K}from"./sceneUboDeclaration-oWm82x75.js";import{m as Q}from"./meshUboDeclaration-BDePVRmu.js";import{o as J}from"./openpbrUboDeclaration-DTjAp98n.js";import{m as ee}from"./mainUVVaryingDeclaration-BYE_OKuF.js";import{p as re,s as ae,i as te,a as ie,b as ne,c as oe,h as fe,d as se,e as le,f as ce,g as _e,j as me,k as de}from"./pbrDebug-ByKyw2QX.js";import{s as ue,r as pe}from"./reflectionFunction-CMxKiC5F.js";import{p as ge,a as ve}from"./pbrIBLFunctions-cRl2RX4G.js";import{c as Ee,a as Se}from"./clipPlaneFragment-Caj7eiCh.js";import{l as he}from"./logDepthDeclaration-B9hGqRLx.js";import{f as Ie,a as Re}from"./fogFragment-DOVn6XHt.js";import{h as be}from"./helperFunctions-CN2o3lpu.js";import{h as Te}from"./harmonicsFunctions-Bmv-P1O5.js";import{p as Ae}from"./pbrBRDFFunctions-DoNMRejL.js";import{o as Ne,a as Le,b as Fe,c as De,d as Oe}from"./openpbrTransmissionLayerData-BSvCF840.js";import{l as Ce}from"./logDepthFragment-L-u2Vywg.js";import"./index-BLhDdMEg.js";import"./react-BikoVsHo.js";import"./motion-DmZWFm6O.js";import"./router-DHWxIZD9.js";const a="openpbrFragmentSamplersDeclaration",I=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=b);const Me={name:i,shader:b},n="openpbrConductorReflectance",T=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=T);const xe={name:n,shader:T},o="openpbrAmbientOcclusionFunctions",A=`fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=A);const ye={name:o,shader:A},f="openpbrVolumeFunctions",N=`struct OpenPBRHomogeneousVolume {extinction_coeff: vec3f, 
ss_albedo: vec3f, 
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=N);const We={name:f,shader:N},s="openpbrNormalMapFragment",L=`var uvOffset: vec2f= vec2f(0.0,0.0);
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=P);const Be={name:d,shader:P},u="openpbrAmbientOcclusionData",G=`var ambient_occlusion: vec3f=vec3f(1.0f,1.0f,1.0f);var specular_ambient_occlusion: f32=1.0f;var coat_specular_ambient_occlusion: f32=1.0f;
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=G);const Ve={name:u,shader:G},p="openpbrBackgroundTransmission",M=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=M);const ke={name:p,shader:M},g="openpbrEnvironmentLighting",x=`#if defined(REFLECTION) || defined(REFRACTED_BACKGROUND)
...
#endif
`;e.IncludesShadersStoreWGSL[g]||(e.IncludesShadersStoreWGSL[g]=x);const Ye={name:g,shader:x},v="openpbrDirectLightingInit",y=`#ifdef LIGHT{X}
...
`;e.ShadersStoreWGSL[h]||(e.ShadersStoreWGSL[h]=U);const qe=[w,X,K,Q,J,ee,re,H,ue,ge,Pe,B,Ee,he,Ie,V,be,ae,te,ie,k,Y,Te,Z,ne,oe,Ae,fe,j,se,le,ce,ve,Ge,Me,pe,Ne,xe,ye,Le,Fe,We,Se,_e,ze,Ue,we,De,Oe,Xe,He,Be,Ve,$,ke,Ye,Ze,je,Ce,Re,me,$e,q,de];for(const r of qe)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const Er={name:h,shader:U};export{Er as openpbrPixelShaderWGSL};
