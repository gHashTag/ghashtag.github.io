import{S as e}from"./QueenCombBabylon-Ccpv0aSp.js";import{p as w,o as X,l as H,i as B,t as V,b as k,s as Y,a as Z,c as j,d as $,e as q}from"./oitFragment-BHcVH-95.js";import{s as K}from"./sceneUboDeclaration-D5Q8RzF6.js";import{m as Q}from"./meshUboDeclaration--B1e60vE.js";import{o as J}from"./openpbrUboDeclaration-BdycnqCd.js";import{m as ee}from"./mainUVVaryingDeclaration-Dc-9xLgH.js";import{p as re,s as ae,i as te,a as ie,b as ne,c as oe,h as fe,d as se,e as le,f as ce,g as _e,j as me,k as de}from"./pbrDebug-CcHBeUtp.js";import{s as ue,r as pe}from"./reflectionFunction-dUD2nWZV.js";import{p as ge,a as ve}from"./pbrIBLFunctions-FwJs8Rtu.js";import{c as Ee,a as Se}from"./clipPlaneFragment-CghPFhRW.js";import{l as he}from"./logDepthDeclaration-CcUUlM7M.js";import{f as Ie,a as Re}from"./fogFragment-ETrL8wxa.js";import{h as be}from"./helperFunctions-CxVic7Yl.js";import{h as Te}from"./harmonicsFunctions-Bnux2wkV.js";import{p as Ae}from"./pbrBRDFFunctions-HPZvDwJd.js";import{o as Ne,a as Le,b as Fe,c as De,d as Oe}from"./openpbrTransmissionLayerData-BCtFocf-.js";import{l as Ce}from"./logDepthFragment-BANHhSOg.js";import"./react-Be6y7_DR.js";import"./three-C7rSOEFP.js";import"./Queen-kFVbQ4B_.js";import"./index-DjsccCAJ.js";import"./motion-CsGAkEsf.js";import"./router-BHJoP3Ih.js";const a="openpbrFragmentSamplersDeclaration",I=`#include<samplerFragmentDeclaration>(_DEFINENAME_,BASE_COLOR,_VARYINGNAME_,BaseColor,_SAMPLERNAME_,baseColor)
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=b);const xe={name:i,shader:b},n="openpbrConductorReflectance",T=`#define pbr_inline
...
#endif
outParams.F0=1.0f;outParams.F90=1.0f;return outParams;}`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=T);const Me={name:n,shader:T},o="openpbrAmbientOcclusionFunctions",A=`fn compute_specular_occlusion(n_dot_v: f32,metallic: f32,ambient_occlusion: f32,roughness: f32)->f32
...
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=G);const Ve={name:u,shader:G},p="openpbrBackgroundTransmission",x=`var slab_translucent_background: vec4f=vec4f(0.,0.,0.,1.);
#ifdef REFRACTED_BACKGROUND
...
`;e.ShadersStoreWGSL[h]||(e.ShadersStoreWGSL[h]=U);const qe=[w,X,K,Q,J,ee,re,H,ue,ge,Pe,B,Ee,he,Ie,V,be,ae,te,ie,k,Y,Te,Z,ne,oe,Ae,fe,j,se,le,ce,ve,Ge,xe,pe,Ne,Me,ye,Le,Fe,We,Se,_e,ze,Ue,we,De,Oe,Xe,He,Be,Ve,$,ke,Ye,Ze,je,Ce,Re,me,$e,q,de];for(const r of qe)e.IncludesShadersStoreWGSL[r.name]||(e.IncludesShadersStoreWGSL[r.name]=r.shader);const hr={name:h,shader:U};export{hr as openpbrPixelShaderWGSL};
