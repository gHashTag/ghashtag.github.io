import{S as e}from"./QueenCombBabylon-C8Ncj2QC.js";const r="openpbrDielectricReflectance",f=`struct ReflectanceParams
{F0: f32,
F90: f32,
coloredF0: vec3f,
coloredF90: vec3f,};
...
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=f);const m={name:r,shader:f},i="openpbrGeometryInfo",t=`struct geometryInfoOutParams
{NdotV: f32,
NdotVUnclamped: f32,
...
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=t);const u={name:i,shader:t},n="openpbrIblFunctions",c=`#ifdef REFLECTION
fn sampleIrradiance(
surfaceNormal: vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=l);const I={name:a,shader:l};export{u as a,v as b,I as c,p as d,m as o};
