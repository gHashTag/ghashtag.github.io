import{S as e}from"./QueenCombBabylon-C8Ncj2QC.js";const i="sceneFragmentDeclaration",c=`uniform mat4 viewProjection;
#ifdef MULTIVIEW
uniform mat4 viewProjectionR;
#endif
uniform mat4 view;uniform mat4 projection;uniform vec4 vEyePosition;uniform mat4 inverseProjection;
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=c);const u={name:i,shader:c},n="openpbrDielectricReflectance",s=`struct ReflectanceParams
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=s);const v={name:n,shader:s},r="openpbrGeometryInfo",f=`struct geometryInfoOutParams
...
{geometryInfoOutParams geoInfo=geometryInfo(normalW,viewDirectionW,roughness,geometricNormalW);geometryInfoAnisoOutParams outParams;outParams.NdotV=geoInfo.NdotV;outParams.NdotVUnclamped=geoInfo.NdotVUnclamped;outParams.environmentBrdf=geoInfo.environmentBrdf;outParams.horizonOcclusion=geoInfo.horizonOcclusion;outParams.anisotropy=vAnisotropy.b;vec3 anisotropyDirection=vec3(vAnisotropy.xy,0.);mat3 anisoTBN=mat3(normalize(TBN[0]),normalize(TBN[1]),normalize(TBN[2]));outParams.anisotropicTangent=normalize(anisoTBN*anisotropyDirection);outParams.anisotropicBitangent=normalize(cross(anisoTBN[2],outParams.anisotropicTangent));outParams.TBN=TBN;return outParams;}`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=f);const I={name:r,shader:f},o="openpbrIblFunctions",l=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=m);const S={name:t,shader:m};export{I as a,E as b,S as c,p as d,v as o,u as s};
