import{S as e}from"./QueenCombBabylon-Ccpv0aSp.js";import{p as z,o as K,l as $,i as q,t as Z,b as J,s as j,a as Q,c as ee,d as ae,e as ie}from"./oitFragment-BHcVH-95.js";import{s as re}from"./sceneUboDeclaration-D5Q8RzF6.js";import{m as ne}from"./meshUboDeclaration--B1e60vE.js";import{p as fe}from"./pbrUboDeclaration-wmebHB6-.js";import{m as oe}from"./mainUVVaryingDeclaration-Dc-9xLgH.js";import{p as te,s as ce,i as le,a as de,b as se,c as Ee,h as Re,d as Se,e as me,f as Ce,g as ue,j as ve,k as Ie}from"./pbrDebug-CcHBeUtp.js";import{s as Ae,r as pe}from"./reflectionFunction-dUD2nWZV.js";import{p as Ne,a as Oe}from"./pbrIBLFunctions-FwJs8Rtu.js";import{c as Te,a as Le}from"./clipPlaneFragment-CghPFhRW.js";import{l as _e}from"./logDepthDeclaration-CcUUlM7M.js";import{f as Me,a as De}from"./fogFragment-ETrL8wxa.js";import{h as Fe}from"./helperFunctions-CxVic7Yl.js";import{h as ge}from"./harmonicsFunctions-Bnux2wkV.js";import{p as Pe}from"./pbrBRDFFunctions-HPZvDwJd.js";import{b as he,a as Ue,c as be}from"./bumpFragment-DndfPUaU.js";import{d as ye,l as Ge}from"./lightFragment-WgjD2rl0.js";import{l as Be}from"./logDepthFragment-BANHhSOg.js";import"./react-Be6y7_DR.js";import"./three-C7rSOEFP.js";import"./Queen-kFVbQ4B_.js";import"./index-DjsccCAJ.js";import"./motion-CsGAkEsf.js";import"./router-BHJoP3Ih.js";const i="samplerFragmentAlternateDeclaration",T=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=T);const Ve={name:i,shader:T},r="pbrFragmentSamplersDeclaration",L=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=L);const We={name:r,shader:L},n="pbrBlockAlbedoOpacity",_=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=_);const He={name:n,shader:_},f="pbrBlockReflectivity",M=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=M);const xe={name:f,shader:M},o="pbrBlockAmbientOcclusion",D=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=D);const Xe={name:o,shader:D},t="pbrBlockAlphaFresnel",F=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=F);const Ye={name:t,shader:F},c="pbrBlockAnisotropic",g=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[c]||(e.IncludesShadersStoreWGSL[c]=g);const ke={name:c,shader:g},l="pbrBlockReflection",P=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[l]||(e.IncludesShadersStoreWGSL[l]=P);const we={name:l,shader:P},d="pbrBlockSheen",h=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=h);const ze={name:d,shader:h},s="pbrBlockClearcoat",U=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=U);const Ke={name:s,shader:U},E="pbrBlockIridescence",b=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=b);const $e={name:E,shader:b},R="pbrBlockSubSurface",y=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[R]||(e.IncludesShadersStoreWGSL[R]=y);const qe={name:R,shader:y},S="pbrBlockNormalFinal",G=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[S]||(e.IncludesShadersStoreWGSL[S]=G);const Ze={name:S,shader:G},m="pbrBlockLightmapInit",B=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=B);const Je={name:m,shader:B},C="pbrBlockGeometryInfo",V=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=V);const je={name:C,shader:V},u="pbrBlockReflectance",W=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[u]||(e.IncludesShadersStoreWGSL[u]=W);const Qe={name:u,shader:W},v="pbrBlockDirectLighting",H=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStoreWGSL[v]||(e.IncludesShadersStoreWGSL[v]=H);const ea={name:v,shader:H},I="pbrBlockFinalLitComponents",x=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=x);const aa={name:I,shader:x},A="pbrBlockFinalUnlitComponents",X=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=X);const ia={name:A,shader:X},p="pbrBlockFinalColorComposition",Y=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=Y);const ra={name:p,shader:Y},N="pbrBlockPrePass",k=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=k);const na={name:N,shader:k},O="pbrPixelShader",w=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStoreWGSL[O]||(e.ShadersStoreWGSL[O]=w);const fa=[z,K,re,ne,fe,oe,te,$,Ae,Ve,Ne,We,q,Te,_e,Me,Z,Fe,ce,le,de,J,j,ge,Q,se,Ee,Pe,Re,ee,Se,me,Ce,Oe,he,Ue,pe,ye,He,xe,Xe,Ye,ke,we,ze,Ke,$e,qe,Le,ue,be,Ze,ae,Je,je,Qe,ea,Ge,aa,ia,ra,Be,De,ve,na,ie,Ie];for(const a of fa)e.IncludesShadersStoreWGSL[a.name]||(e.IncludesShadersStoreWGSL[a.name]=a.shader);const ga={name:O,shader:w};export{ga as pbrPixelShaderWGSL};
