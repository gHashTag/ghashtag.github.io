import{bF as e}from"./Queen-Ceq0_SNN.js";import{p as j,o as Q,d as ee,l as ie,a as ne,i as ae,t as re,c as oe,s as fe,b as te,e as ce,f as le}from"./oitFragment-CUcLF0u1.js";import{s as de}from"./sceneUboDeclaration-BuidJ8Vh.js";import{m as se}from"./meshUboDeclaration-ClOJbz9N.js";import{p as Ee}from"./pbrUboDeclaration-O9GVypXT.js";import{m as Re}from"./mainUVVaryingDeclaration-464c3XgC.js";import{p as Ce,s as Se,i as me,a as ue,b as Ae,c as Ie,h as ve,d as Te,e as Ne,f as Oe,g as pe}from"./pbrDebug-Cz0ckrPZ.js";import{s as Le,r as _e}from"./reflectionFunction-B6KHZLqf.js";import{p as De,a as Me}from"./pbrIBLFunctions-Bzpj3zxy.js";import{c as he,a as Fe}from"./clipPlaneFragment-BQiLstQ5.js";import{l as ge}from"./logDepthDeclaration-BWbgFLhj.js";import{f as Pe,a as be}from"./fogFragment-Ie5S6brz.js";import{h as Ue}from"./helperFunctions-VQbUKDzJ.js";import{h as ye}from"./harmonicsFunctions-DbB0Iz3X.js";import{p as Be}from"./pbrBRDFFunctions-Mzcb9vls.js";import{b as Ge,a as Ve,c as He}from"./bumpFragment-qzbLAMap.js";import{d as xe,c as Xe,l as We}from"./lightFragment-CJ2QJhvi.js";import{l as Ye}from"./logDepthFragment-DdKmRH4j.js";import"./index-sqbcDw24.js";import"./react-BikoVsHo.js";import"./motion-DmZWFm6O.js";import"./router-DHWxIZD9.js";const n="pbrFragmentDeclaration",D=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform float baseDiffuseRoughness;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=D);const ke={name:n,shader:D},a="samplerFragmentAlternateDeclaration",M=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=M);const we={name:a,shader:M},r="pbrFragmentSamplersDeclaration",h=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=h);const Ke={name:r,shader:h},o="pbrBlockAlbedoOpacity",F=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=F);const ze={name:o,shader:F},f="pbrBlockReflectivity",g=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=g);const $e={name:f,shader:g},t="pbrBlockAmbientOcclusion",P=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=P);const Ze={name:t,shader:P},c="pbrBlockAlphaFresnel",b=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[c]||(e.IncludesShadersStore[c]=b);const qe={name:c,shader:b},l="pbrBlockAnisotropic",U=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=U);const Je={name:l,shader:U},d="pbrBlockReflection",y=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=y);const je={name:d,shader:y},s="pbrBlockSheen",B=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=B);const Qe={name:s,shader:B},E="pbrBlockClearcoat",G=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=G);const ei={name:E,shader:G},R="pbrBlockIridescence",V=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[R]||(e.IncludesShadersStore[R]=V);const ii={name:R,shader:V},C="pbrBlockSubSurface",H=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=H);const ni={name:C,shader:H},S="pbrBlockReflectance0",x=`float reflectanceF0=reflectivityOut.reflectanceF0;vec3 specularEnvironmentR0=reflectivityOut.colorReflectanceF0;vec3 specularEnvironmentR90=reflectivityOut.colorReflectanceF90;
#ifdef ALPHAFRESNEL
float reflectance90=fresnelGrazingReflectance(reflectanceF0);specularEnvironmentR90=specularEnvironmentR90*reflectance90;
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=x);const ai={name:S,shader:x},m="pbrClusteredLightingFunctions",X=`#if defined(CLUSTLIGHT_BATCH) && CLUSTLIGHT_BATCH>0
...
return result;}
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=X);const ri={name:m,shader:X},u="pbrBlockNormalFinal",W=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
#endif
`;e.IncludesShadersStore[u]||(e.IncludesShadersStore[u]=W);const oi={name:u,shader:W},A="pbrBlockLightmapInit",Y=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[A]||(e.IncludesShadersStore[A]=Y);const fi={name:A,shader:Y},I="pbrBlockGeometryInfo",k=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[I]||(e.IncludesShadersStore[I]=k);const ti={name:I,shader:k},v="pbrBlockReflectance",w=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=w);const ci={name:v,shader:w},T="pbrBlockDirectLighting",K=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SS_TRANSLUCENCY
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=K);const li={name:T,shader:K},N="pbrBlockFinalLitComponents",z=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=z);const di={name:N,shader:z},O="pbrBlockFinalUnlitComponents",$=`vec3 finalDiffuse=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStore[O]||(e.IncludesShadersStore[O]=$);const si={name:O,shader:$},p="pbrBlockFinalColorComposition",Z=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=Z);const Ei={name:p,shader:Z},L="pbrBlockPrePass",q=`#if SCENE_MRT_COUNT>0
...
#endif
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=q);const Ri={name:L,shader:q},_="pbrPixelShader",J=`#define PBR_FRAGMENT_SHADER
...
`;e.ShadersStore[_]||(e.ShadersStore[_]=J);const Ci=[j,Q,ee,ke,de,se,Ee,Re,Ce,ie,ne,Le,we,De,Ke,ae,he,ge,Pe,re,Ue,Se,me,ue,oe,fe,ye,te,Ae,Ie,Be,ve,Te,Me,Ge,Ve,_e,xe,ze,$e,Ze,qe,Je,je,Qe,ei,ii,ni,Xe,ai,ri,Fe,Ne,He,oi,ce,fi,ti,ci,li,We,di,si,Ei,Ye,be,Oe,Ri,le,pe];for(const i of Ci)e.IncludesShadersStore[i.name]||(e.IncludesShadersStore[i.name]=i.shader);const Gi={name:_,shader:J};export{Gi as pbrPixelShader};
