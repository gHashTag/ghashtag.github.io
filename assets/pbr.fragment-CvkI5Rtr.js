import{bY as e}from"./Queen-CHuCUg0D.js";import{p as z,o as K,l as $,i as q,t as Z,b as J,s as j,a as Q,c as ee,d as ae,e as ie}from"./oitFragment-DpO7gOI8.js";import{s as re}from"./sceneUboDeclaration-B5HnelIu.js";import{m as ne}from"./meshUboDeclaration-dTXUQfYg.js";import{p as fe}from"./pbrUboDeclaration-S9DtDScq.js";import{m as oe}from"./mainUVVaryingDeclaration-B9JwSpyD.js";import{p as te,s as ce,i as le,a as de,b as se,c as Ee,h as Re,d as Se,e as me,f as Ce,g as ue,j as ve,k as Ie}from"./pbrDebug-Cf9-VqOs.js";import{s as Ae,r as pe}from"./reflectionFunction-DLa-_KPA.js";import{p as Ne,a as Oe}from"./pbrIBLFunctions-Dyo-r_Ux.js";import{c as Te,a as Le}from"./clipPlaneFragment-l5j87lrh.js";import{l as _e}from"./logDepthDeclaration-DsHm4jTV.js";import{f as Me,a as De}from"./fogFragment-CMLExdpA.js";import{h as Fe}from"./helperFunctions-5SQWhhXO.js";import{h as ge}from"./harmonicsFunctions-BBjDbcEE.js";import{p as Pe}from"./pbrBRDFFunctions-B1hXLxea.js";import{b as he,a as Ue,c as be}from"./bumpFragment-fb7BWhkY.js";import{d as ye,l as Ge}from"./lightFragment-CS2kFb-o.js";import{l as Be}from"./logDepthFragment-BdiczvyP.js";import"./index-DJt6CJOG.js";import"./react-BikoVsHo.js";import"./motion-DmZWFm6O.js";import"./router-DHWxIZD9.js";const i="samplerFragmentAlternateDeclaration",T=`#ifdef _DEFINENAME_
...
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=D);const Ye={name:o,shader:D},t="pbrBlockAlphaFresnel",F=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=F);const Xe={name:t,shader:F},c="pbrBlockAnisotropic",g=`#ifdef ANISOTROPIC
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[I]||(e.IncludesShadersStoreWGSL[I]=x);const aa={name:I,shader:x},A="pbrBlockFinalUnlitComponents",Y=`var finalDiffuse: vec3f=diffuseBase;finalDiffuse*=surfaceAlbedo;
...
`;e.IncludesShadersStoreWGSL[A]||(e.IncludesShadersStoreWGSL[A]=Y);const ia={name:A,shader:Y},p="pbrBlockFinalColorComposition",X=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=X);const ra={name:p,shader:X},N="pbrBlockPrePass",k=`#if SCENE_MRT_COUNT>0
...
`;e.ShadersStoreWGSL[O]||(e.ShadersStoreWGSL[O]=w);const fa=[z,K,re,ne,fe,oe,te,$,Ae,Ve,Ne,We,q,Te,_e,Me,Z,Fe,ce,le,de,J,j,ge,Q,se,Ee,Pe,Re,ee,Se,me,Ce,Oe,he,Ue,pe,ye,He,xe,Ye,Xe,ke,we,ze,Ke,$e,qe,Le,ue,be,Ze,ae,Je,je,Qe,ea,Ge,aa,ia,ra,Be,De,ve,na,ie,Ie];for(const a of fa)e.IncludesShadersStoreWGSL[a.name]||(e.IncludesShadersStoreWGSL[a.name]=a.shader);const Da={name:O,shader:w};export{Da as pbrPixelShaderWGSL};
