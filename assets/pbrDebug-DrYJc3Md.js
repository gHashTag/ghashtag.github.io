import{bI as e}from"./Queen-Cw0Rpa4M.js";import"./mainUVVaryingDeclaration-cqVfHF4c.js";import"./oitFragment-CEGj6Two.js";const t="pbrFragmentExtraDeclaration",g=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=E);const I={name:a,shader:E},n="pbrDirectLightingSetupFunctions",L=`struct preLightingInfo
...
result.areaLightDiffuse=data.Diffuse;result.LdotV=0.;result.roughness=0.;result.diffuseRoughness=0.;result.surfaceAlbedo=vec3(0.);return result;}
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=L);const _={name:n,shader:L},r="pbrDirectLightingFalloffFunctions",p=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=C);const P={name:d,shader:C};export{I as a,_ as b,R as c,b as d,U as e,G as f,P as g,B as h,O as i,M as p,F as s};
