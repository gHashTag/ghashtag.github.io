import{S as e}from"./QueenCombBabylon-DOdGX8_Q.js";const r="pbrFragmentReflectionDeclaration",i=`#ifdef REFLECTION
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=i);const o={name:r,shader:i},a="pbrIBLFunctions",n=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=n);const l={name:a,shader:n};export{l as a,o as p};
