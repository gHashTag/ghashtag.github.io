import{S as e}from"./QueenCombBabylon-DJ7kDGWi.js";const r="samplerFragmentDeclaration",i=`#ifdef _DEFINENAME_
...
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=i);const n={name:r,shader:i},o="reflectionFunction",f=`fn computeFixedEquirectangularCoords(worldPos: vec4f,worldNormal: vec3f,direction: vec3f)->vec3f
...
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=f);const t={name:o,shader:f};export{t as r,n as s};
