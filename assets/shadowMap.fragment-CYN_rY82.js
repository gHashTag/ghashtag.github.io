import{bF as e}from"./Queen-DnIekj8u.js";import{p as d}from"./packingFunctions-Bf2KN6HK.js";import{c as p,a as c}from"./clipPlaneFragment-DKqE3zwF.js";import"./index-D6MTppPL.js";import"./react-BikoVsHo.js";import"./motion-DmZWFm6O.js";import"./router-DHWxIZD9.js";const r="bayerDitherFunctions",f=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=f);const h={name:r,shader:f},t="shadowMapFragmentExtraDeclaration",S=`#if SM_FLOAT==0
...
varying zSM: f32;
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=S);const m={name:t,shader:S},n="shadowMapFragment",s=`var depthSM: f32=fragmentInputs.vDepthMetricSM;
#if defined(SM_DEPTHCLAMP) && SM_DEPTHCLAMP==1
#if SM_USEDISTANCE==1
...
}`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=o);const l=[d,h,m,p,c,u];for(const a of l)e.IncludesShadersStoreWGSL[a.name]||(e.IncludesShadersStoreWGSL[a.name]=a.shader);const D={name:i,shader:o};export{D as shadowMapPixelShaderWGSL};
