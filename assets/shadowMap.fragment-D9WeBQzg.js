import{S as e}from"./QueenCombBabylon-Ccpv0aSp.js";import{p as d}from"./packingFunctions-D6DF_hXl.js";import{c as p,a as c}from"./clipPlaneFragment-CghPFhRW.js";import"./react-Be6y7_DR.js";import"./three-C7rSOEFP.js";import"./Queen-kFVbQ4B_.js";import"./index-DjsccCAJ.js";import"./motion-CsGAkEsf.js";import"./router-BHJoP3Ih.js";const r="bayerDitherFunctions",f=`fn bayerDither2(_P: vec2f)->f32 {return ((2.0*_P.y+_P.x+1.0)%(4.0));}
...
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=f);const m={name:r,shader:f},t="shadowMapFragmentExtraDeclaration",S=`#if SM_FLOAT==0
...
varying zSM: f32;
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=S);const h={name:t,shader:S},n="shadowMapFragment",s=`var depthSM: f32=fragmentInputs.vDepthMetricSM;
#if defined(SM_DEPTHCLAMP) && SM_DEPTHCLAMP==1
#if SM_USEDISTANCE==1
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=s);const u={name:n,shader:s},i="shadowMapPixelShader",o=`#include<shadowMapFragmentExtraDeclaration>
#ifdef ALPHATEXTURE
...
}`;e.ShadersStoreWGSL[i]||(e.ShadersStoreWGSL[i]=o);const l=[d,m,h,p,c,u];for(const a of l)e.IncludesShadersStoreWGSL[a.name]||(e.IncludesShadersStoreWGSL[a.name]=a.shader);const F={name:i,shader:o};export{F as shadowMapPixelShaderWGSL};
