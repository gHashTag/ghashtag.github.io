import{S as e}from"./QueenCombBabylon-cBwhf22i.js";const t="bonesDeclaration",u=`#if NUM_BONE_INFLUENCERS>0
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=u);const L={name:t,shader:u},n="bakedVertexAnimationDeclaration",l=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
`;e.IncludesShadersStoreWGSL[n]||(e.IncludesShadersStoreWGSL[n]=l);const T={name:n,shader:l},r="instancesDeclaration",c=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[r]||(e.IncludesShadersStoreWGSL[r]=c);const V={name:r,shader:c},i="clipPlaneVertexDeclaration",I=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=I);const C={name:i,shader:I},a="instancesVertex",x=`#ifdef INSTANCES
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[a]||(e.IncludesShadersStoreWGSL[a]=x);const _={name:a,shader:x},f="bonesVertex",E=`#ifndef BAKED_VERTEX_ANIMATION_TEXTURE
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[f]||(e.IncludesShadersStoreWGSL[f]=E);const O={name:f,shader:E},s="bakedVertexAnimation",S=`#ifdef BAKED_VERTEX_ANIMATION_TEXTURE
{
#ifdef INSTANCES
...
#endif
`;e.IncludesShadersStoreWGSL[s]||(e.IncludesShadersStoreWGSL[s]=S);const W={name:s,shader:S},d="clipPlaneVertex",N=`#ifdef CLIPPLANE
...
#endif
`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=N);const R={name:d,shader:N},o="fogVertex",v=`#ifdef FOG
#ifdef SCENE_UBO
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=v);const P={name:o,shader:v},m="vertexColorMixing",p=`#if defined(VERTEXCOLOR) || defined(INSTANCESCOLOR) && defined(INSTANCES)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=p);const F={name:m,shader:p};export{T as a,L as b,C as c,_ as d,O as e,W as f,R as g,P as h,V as i,F as v};
