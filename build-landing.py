...
def sitemap(slugs):
    ...
    # /orb/ is a hand-written product page, not one of PAGES: its copy is the
    # product's own landing rather than a condensation of an SPA route, so the
    # generator has nothing to render it from and cannot see it. Listed here for
    # the same reason leela_surfaces() exists — a page absent from the sitemap is
